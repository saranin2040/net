...
public class ClientHandler extends Attachment implements Closeable {
    ...
    public ClientHandler(DNSResolver dnsResolver, SelectionKey clientKey) {
    ...
    public void createResponse( SOCKSErrorCode errorCode) {
    ...
    private ClientHandlerState getStateByErrorCode( SOCKSErrorCode errorCode) {
