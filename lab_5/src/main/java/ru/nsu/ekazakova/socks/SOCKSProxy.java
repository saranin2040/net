package ru.nsu.ekazakova.socks;

import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import ru.nsu.ekazakova.attachment.AcceptHandler;
import ru.nsu.ekazakova.attachment.Attachment;
import ru.nsu.ekazakova.attachment.ClientHandler;
import ru.nsu.ekazakova.attachment.ServerHandler;
import ru.nsu.ekazakova.dns.DNSQueueOperationsWithExceptionsStrategy;
import ru.nsu.ekazakova.dns.DNSResolver;
import ru.nsu.ekazakova.utils.PortValidator;
...
public class SOCKSProxy implements Closeable {
    ...
    private void handleAttachment( Object attachmentObj) {
    ...
    private void handle( ServerHandler serverHandler) {
        try {
    ...
    private void workWithServerHandler( ServerHandler serverHandler) {
    ...
    private void handle( AcceptHandler acceptHandler) {
        try {
    ...
    private void handle( DNSResolver resolver) {
        try {
    ...
    private void handle( ClientHandler clientHandler) {
        try {
    ...
    private void workWithClientHandler( ClientHandler clientHandler) {
