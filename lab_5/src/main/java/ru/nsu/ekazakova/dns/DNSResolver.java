...
import ru.nsu.ekazakova.attachment.AttachmentType;
import ru.nsu.ekazakova.attachment.ClientHandler;
import ru.nsu.ekazakova.socks.SOCKSErrorCode;
import ru.nsu.ekazakova.utils.SelectionKeyUtils;
...
public class DNSResolver extends Attachment implements Closeable {
    ...
    public DNSResolver( Selector selector) {
    ...
    public void setDnsQueueStrategy( DNSQueueStrategy dnsQueueStrategy) {
        this.dnsQueueStrategy = Objects.requireNonNull(dnsQueueStrategy, "Dns queue strategy cant be null");
    }

    public void appendResolveRequest( String hostToResolve,  ClientHandler clientHandler) {
